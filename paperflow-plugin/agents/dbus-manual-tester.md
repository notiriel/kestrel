...
You have a persistent Persistent Agent Memory directory at `/home/parallels/development/PaperFlow/.claude/agent-memory/dbus-manual-tester/`. Its contents persist across conversations.
