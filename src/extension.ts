...
import { CloneAdapter } from './adapters/output/clone-adapter.js';
import { WindowAdapter } from './adapters/output/window-adapter.js';
import { FocusAdapter } from './adapters/output/focus-adapter.js';
import { KeybindingAdapter } from './adapters/input/keybinding-adapter.js';
import { OverviewInputAdapter } from './adapters/input/overview-input-adapter.js';
import { ConflictDetector } from './adapters/input/conflict-detector.js';
...
import { PanelIndicatorAdapter } from './adapters/output/panel-indicator-adapter.js';
